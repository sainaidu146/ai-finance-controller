...
The app is intentionally local-first for this first build. The reconciliation table, evidence drawer, filters, rerun state, cash outlook, and exception resolution queue all use realistic synthetic data so the control loop can be evaluated without connecting production finance systems.
